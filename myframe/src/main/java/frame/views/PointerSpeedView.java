...
import frame.views.base.Speedometer;
import frame.views.base.SpeedometerDefault;
import frame.views.components.Indicators.SpindleIndicator;
...
public class PointerSpeedView extends Speedometer {
    ...
    protected SpeedometerDefault getSpeedometerDefault() {
        ...
        speedometerDefault.backgroundCircleColor = Color.parseColor("#2272eb");
